...
ln -s ~/Sites/google-auth-sdk google-workspace-sdk
```
...
"autoload": {
    "psr-4": {
        "App\\": "app/",
        "Glamstack\\GoogleAuth\\": "packages/glamstack/google-workspace-sdk/src"
    }
},
```
...
# Copied File [/Users/jmartin/Sites/gitlab-sdk/src/Config/glamstack-google-workspace.php] To [/config/glamstack-google-workspace.php]
# Publishing complete.
```
