...
class Rest extends ApiClient
{
    ...
    public function get(string $url, array $request_data = []): object|string
    {
        ...
        return $method->get($url, $request_data);
    }
    ...
    {
        $method = new Method($this);
        return $method->post($url, $request_data);
    }
    ...
    {
        $method = new Method($this);
        return $method->patch($url, $request_data);
    }
    ...
    {
        $method = new Method($this);
        return $method->put($url, $request_data);
    }
    ...
    {
        $method = new Method($this);
        return $method->delete($url, $request_data);
    }
}
