...
class WorkspaceApiClient
{
    ...
    public function delete(string $uri, array $request_data = []): object
    {
        ...
        //     } else {
        //         abort(500, 'The Google Workspace SDK failed due to an unknown reason in the DELETE method.');
        //     }
        // }
    ...
    protected function getNextPageResults(
        ...
        $new_response = $this->parseApiResponse($records);
        $this->logResponse('get', self::BASE_URL . $uri, $new_response);
